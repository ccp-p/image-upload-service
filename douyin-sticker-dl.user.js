...
(function () {
    ...
    // ==================== 常量 ====================
    var STICKER_SELECTOR = 'img[data-sticker-handled="true"], img[src*="douyinpic.com"][src*="biz_tag=aweme_comment"]';
    ...
    function createButton(img) {
        ...
        btn.innerHTML = '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>';
